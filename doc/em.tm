...
<style|<tuple|amsart|structured-section|better-amsart>>
...
<\body>
  ...
  <\doc-data|<doc-title|Expectation Maximization>>
    \;
  <|doc-data>
    \;
  ...
  <abstract-data|<abstract|We review some concepts from Gaussian mixtures
  with latent variables, then explain how an iterative algorithm,
  Expectation-Maximization, appears naturally for the estimation of the
  parameters. We apply it to mixtures of Gaussian and Bernoulli variables. We
  also say a few words about the Kullback-Leibler divergence to be able to
  show why EM works.>>

  <\render-remark|>
    Warning! These notes are heavily based on
    <cite-detail|bishop_pattern_2006|Chapters 9 and 1.6>. You might prefer to
    read that instead...<set-this-page-footer|<small|<with-TeXmacs-text>>>
  </render-remark>
  ...
  <\small>
    <\with|ornament-shape|rounded|ornament-color|pastel red>
      <\table-of-contents|toc>
        ...
        <with|par-left|1tab|8.1.<space|2spc>A word about conditional
        ...
        <with|par-left|1tab|8.4.<space|2spc>Maximization of the log
  ...
  <\section|Notation and conventions>
    ...
    for the <strong|latent variables>, e.g. those \Partificially\Q added to
    ...
    the density of <math|Z> \Pgiven <math|X=x>\Q at <math|z>, etc. (see
    ...
    same line, but is always understood as \Pthe parameters for the
    distribution where <math|\<theta\>> is used\Q. Conditioning wrt.
    ...
    in <math|\<bbb-R\><rsup|d>>. They are observations of <math|X>, i.e. we
    have the <strong|joint random variable>
  ...
  <\section|Gaussian Mixtures with latent variables<label|sec:gmm-latent>>
    ...
    be interpreted as: the corresponding realization of <math|X> \Pcomes
    from\Q the distribution <math|\<cal-N\><around*|(|\<mu\><rsub|k>,\<Sigma\><rsub|k>|)>>,
    i.e. we want to set
    ...
    of the <math|e<rsub|k>> (i.e. <math|z<rsub|j>\<in\><around*|{|0,1|}>> and
    <math|<big|sum><rsub|j=1><rsup|K>z<rsub|j>=1>) we may write the
    distribution of <math|Z> as
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|p<around*|(|x|)>>|<cell|=>|<cell|<big|sum><rsub|z\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}>>p<around*|(|z|)>*p<around*|(|x\|z|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|K><big|prod><rsub|j=1><rsup|K>\<pi\><rsub|j><rsup|\<delta\><rsub|j\<nocomma\>k>>*<big|prod><rsub|l=1><rsup|K>\<cal-N\><around*|(|x\|\<mu\><rsub|l>,\<Sigma\><rsub|l>|)><rsup|\<delta\><rsub|l\<nocomma\>k>>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k=1><rsup|K>\<pi\><rsub|k>**\<cal-N\><around*|(|x\|\<mu\><rsub|k>,\<Sigma\><rsub|k>|)>.>>>>
    </eqnarray*>
    ...
    the following two problems, which we explain in more detail below.

    <\enumerate>
      <item>We don't obtain closed-form estimators when we differentiate
      <eqref|eq:max-likelihood-marginal>, so we need to devise and justify an
    ...
    <\render-remark|So, why did we introduce <math|Z>? >
    ...
    <\named-algorithm|No-questions-asked-EM for Gaussian mixtures>
      <\enumerate>
        ...
        <item><strong|E-Step:> For the current choice of parameters
        <math|\<theta\>=\<theta\><rsup|old>>, compute the posterior
        <math|p<rsub|\<b-Z\>\|\<b-X\>=\<b-x\>,\<theta\>><around*|(|\<b-z\>|)>>
        or <em|responsibilities>.

        <item><strong|M-Step:> maximize <math|E<rsub|\<b-Z\>\|\<b-X\>=\<b-x\>,\<theta\><rsup|old>><around*|[|log
  ...
  <\section|The EM algorithm<label|sec:em-algor>>
    ...
    <\eqnarray*>
      ...
      <frac|p<around*|(|\<b-x\>,\<b-z\><rprime|'>\|\<theta\>|)>|q<around*|(|\<b-z\><rprime|'>|)>>>>|<row|<cell|KL<around*|(|q\<\|\|\>p<rsub|\<b-Z\>\|\<b-x\>,\<theta\>>|)>>|<cell|\<assign\>>|<cell|-<big|sum><rsub|\<b-z\><rprime|'>\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}><rsup|N>>q<around*|(|\<b-z\><rprime|'>|)>*log
    ...
    <math|log p<around*|(|\<b-x\>\|\<theta\>|)>>.<\footnote>
      Notice that one can also obtain this estimate as an application of
      Jensen's inequality:

      <\equation*>
        log p<around*|(|\<b-x\>\|\<theta\>|)>=log
        <big|int><frac|q<around*|(|\<b-z\><rprime|'>|)>|q<around*|(|\<b-z\><rprime|'>|)>>*p<around*|(|\<b-x\>,\<b-z\><rprime|'>\|\<theta\>|)>*\<mathd\>\<b-z\><rprime|'>\<geqslant\><big|int>q<around*|(|\<b-z\><rprime|'>|)>*log
        <frac|p<around*|(|\<b-x\>,\<b-z\><rprime|'>\|\<theta\>|)>|q<around*|(|\<b-z\><rprime|'>|)>>*\<mathd\>\<b-z\><rprime|'>,
      </equation*>

      where <math|<big|int>q<around*|(|\<b-z\>|)>*\<mathd\>\<b-z\>=1> and
      <math|0\<less\>q<around*|(|\<b-z\>|)>\<leqslant\>1>. See also:
      <reference|th:KL-non-negative>.
    </footnote>

    <with|ornament-shape|rounded|padding-above|0.6fn|padding-below|0.6fn|<\ornamented>
    ...
    <|named-algorithm>
      <\enumerate>
        ...
        <item><strong|E-step:> Set <math|\<theta\>=\<theta\><rsup|t>> in
        <eqref|eq:ll-decomposed>. Maximize the lower bound <math|\<cal-L\>>
        wrt. the distribution <math|q>. This is achieved by minimizing
        <math|KL> because

        <\equation*>
          \<cal-L\><around*|(|q,\<theta\><rsup|t>|)>=log
          p<around*|(|\<b-x\>\|\<theta\><rsup|t>|)>-KL<around*|(|q\<\|\|\>p<rsub|\<b-Z\>\|\<b-x\>,\<theta\><rsup|t>>|)>,
        </equation*>

        and <math|log p<around*|(|\<b-x\>\|\<theta\><rsup|t>|)>> is
        independent of <math|q>. This maximum is realized for the choice
        ...
        p<around*|(|\<b-x\>,\<b-z\>\|\<theta\><rsup|t>|)>>:

        <\equation>
          <label|eq:l-as-expectation>\<cal-L\><around*|(|p<rsub|\<b-Z\>\|\<b-x\>,\<theta\><rsup|t>>,\<theta\><rsup|t>|)>=E<rsub|\<b-Z\>\|\<b-x\>,\<theta\><rsup|t>><around*|[|g<around*|(|\<b-Z\>|)>|]>+C.
        </equation>
  ...
  <\section|Back to Gaussian Mixtures<label|sec:em-with-gm>>
    ...
    to be able to take the logarithm. One would now want to differentiate
    wrt. <math|\<pi\><rsub|k>,\<mu\><rsub|k,>,\<Sigma\><rsub|k>> to do
    maximum likelihood estimation of these parameters, but the problem is we
    don't have the <math|z<rsub|n>>! Luckily <math|EM> saves the day:
    ...
    <\equation*>
      ...
      <below|<wide*|<frac|1|p<around*|(|x<rsub|n>\|\<theta\><rsup|t>|)>>*<big|prod><rsub|k=1><rsup|K><around*|[|\<pi\><rsup|t><rsub|k>*\<cal-N\><around*|(|x<rsub|n>\|\<mu\><rsup|t><rsub|k>,\<Sigma\><rsup|t><rsub|k>|)>|]><rsup|z<rsub|n\<nocomma\>k>>|\<wide-squnderbrace\>>|=:p<rsub|Z\|x<rsub|n>><around*|(|z<rsub|n>|)>>.
    </equation*>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|E<rsub|\<b-Z\>\|\<b-x\>,\<theta\><rsup|t>><around*|[|<with|math-font|Bbb*|1><rsub|<around*|{|e<rsub|k>|}>><around*|(|Z<rsub|n>|)>|]>>|<cell|=>|<cell|<big|sum><rsub|\<b-z\>\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}><rsup|N>><with|math-font|Bbb*|1><rsub|<around*|{|e<rsub|k>|}>><around*|(|z<rsub|n>|)>*p<rsub|\<b-Z\>\|\<b-x\>,\<theta\><rsup|t>><around*|(|\<b-z\>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|\<b-z\>\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}><rsup|N>><with|math-font|Bbb*|1><rsub|<around*|{|e<rsub|k>|}>><around*|(|z<rsub|n>|)>*<around*|(|<big|prod><rsub|j=1><rsup|N>p<rsub|Z\|x<rsub|j>,\<theta\><rsup|t>><around*|(|z<rsub|j>|)>|)>>>|<row|<cell|>|<cell|=>|<cell|<below|<wide*|<big|sum><rsub|z\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}>><with|math-font|Bbb*|1><rsub|<around*|{|e<rsub|k>|}>><around*|(|z|)>*p<rsub|Z\|x<rsub|n>,\<theta\><rsup|t>><around*|(|z|)>|\<wide-squnderbrace\>>|=E<rsub|Z\|x<rsub|n>,\<theta\><rsup|t>><around*|[|<with|math-font|Bbb*|1><rsub|<around*|{|e<rsub|k>|}>><around*|(|Z<rsub|n>|)>|]>>*<below|<wide*|<around*|(|<big|prod><rsub|j=1,j\<neq\>n><rsup|N><big|sum><rsub|z\<in\><around*|{|e<rsub|1>,\<ldots\>,e<rsub|K>|}>>p<rsub|Z\|x<rsub|j>,\<theta\><rsup|t>><around*|(|z|)>|)>|\<wide-squnderbrace\>>|=1>>>|<row|<cell|>|<cell|=>|<cell|p<rsub|Z\|x<rsub|n>,\<theta\><rsup|t>><around*|(|e<rsub|k>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|1|p<around*|(|x<rsub|n>\|\<theta\><rsup|t>|)>>*\<pi\><rsup|t><rsub|k>*\<cal-N\><around*|(|x<rsub|n>\|\<mu\><rsup|t><rsub|k>,\<Sigma\><rsup|t><rsub|k>|)>>>|<row|<cell|>|<cell|=>|<cell|<frac|\<pi\><rsup|t><rsub|k>*\<cal-N\><around*|(|x<rsub|n>\|\<mu\><rsup|t><rsub|k>,\<Sigma\><rsup|t><rsub|k>|)>|<big|sum><rsub|j=1><rsup|K>\<pi\><rsup|t><rsub|j>*\<cal-N\><around*|(|x<rsub|n>\|\<mu\><rsup|t><rsub|j>,\<Sigma\><rsup|t><rsub|j>|)>>=:\<gamma\><rsup|t><rsub|n\<nocomma\>k>.>>>>
    </eqnarray*>
  ...
  <\section|Where to go from here<label|sec:what-next>>
    ...
    <\itemize-dot>
      ...
      problem of \Pcollapsing variances\Q (see Ÿ<reference|sec:problems-ll>).
      Using Bayes' rule and the decomposition <eqref|eq:ll-decomposed> we
      have
      ...
      in <math|log p<around*|(|\<theta\>|)>>. <em|A word of caution:> by
      adding the log prior to the lower bound <math|<wide|\<cal-L\>|~>> it
      can happen that even though at any given step <math|<wide|\<cal-L\>|~>>
      is guaranteed to increase, the log likelihood might decrease, being
      compensated by an increase in <math|log p<around*|(|\<theta\>|)>>.

      <item>Fully Bayesian use of EM (possibly including model selection).
      This will prove to be particularly interesting later when we use EM to
      learn the parameters of e.g. a Hidden Markov Model. It is easy to
      verify experimentally with the simplest of tests that EM gets trapped
      in local maxima and generally fails to converge to the proper
      parameters of the HMM. Regularization techniques like MAP may help to
      avoid corner cases (like transition probabilities of the HMM converging
      to 0) but remain unsatisfactory
  ...
  <\section|Appendix>
    ...
    <\subsection|Problems related to the log likelihood approach>
      ...
      <\render-remark|Non-closed estimators: >
        ...
        There is a simple solution to this: the expressions
        <eqref|eq:mle-mean>, <eqref|eq:mle-cov-resp> for the estimators for
        <math|\<mu\><rsub|k>,\<Sigma\><rsub|k>,\<pi\><rsub|k>> feature the
        variables themselves at the rhs., which suggests that we use a
        Newton-like iterative scheme. However, our different modelling guides
        us to Expectation-Maximization.
    ...
    <\subsection|A few sketchy ideas from information theory>
      ...
      <\itemize-dot>
        ...
        <item>News of event with low probability are \Phigh\Q information.
      </itemize-dot>
      ...
      <\render-proof|Proof. >
        ...
        <math|\<varphi\>> convex and <math|p> a probability density this is:
        <math|\<varphi\><around*|(|<big|int>f*p*\<mathd\>x|)>\<leqslant\><big|int>\<varphi\><around*|(|f|)>*p*\<mathd\>x>,
        when things make sense, the domains match, etc.). By the convexity of
        <math|-log> (recall that we assume <math|p\<gtr\>0>) we can write:
        ...
        where we used that <math|q> is a probability distribution and assumed
        <math|q\<gtr\>0> a.e.
      </render-proof>
  ...
  <\section|References>
    ...
    \ <cite-detail|koller_probabilistic_2009|Chapter 3>. An implementation of
    EM for Gaussians is <hlink|available at
    Bitbucket|https://bitbucket.org/mdbenito/km2em>, together with a
    <TeXmacs> file to demo it.

    <\bibliography|bib|tm-alpha|em.bib>
      <\bib-list|7>
        <bibitem*|AO85><label|bib-anderson_maximum-likelihood_1985>T.<nbsp>W.<nbsp>Anderson<localize|
        and >I.<nbsp>Olkin.<newblock> Maximum-likelihood estimation of the
        parameters of a multivariate normal distribution.<newblock>
        <with|font-shape|italic|Linear Algebra and its Applications>,
        70:147\U171, oct 1985.<newblock>
        ...
        <bibitem*|JP04><label|bib-jacod_probability_2004>Jean Jacod<localize|
        and >Philip Protter.<newblock> <with|font-shape|italic|Probability
        essentials>.<newblock> Universitext. Springer Berlin Heidelberg,
        2<localize| edition>, jan 2004.<newblock>
        ...
        <bibitem*|KF09><label|bib-koller_probabilistic_2009>Daphne
        Koller<localize| and >Nir Friedman.<newblock>
        ...
        <bibitem*|LCB12><label|bib-lecun_mnist_2012>Yan LeCun, Corinna
        Cortes<localize|, and >Christopher<nbsp>J.C.<nbsp>Burges.<newblock>
        The MNIST database of handwritten digits.<newblock> 2012.<newblock>

        <bibitem*|Mur12><label|bib-murphy_machine_2012>Kevin<nbsp>P.<nbsp>Murphy.<newblock>
        <with|font-shape|italic|Machine learning: a probabilistic
        perspective>.<newblock> MIT Press, aug 2012.<newblock>
      </bib-list>
    </bibliography>
  </section>
</body>
...
<\references>
  <\collection>
    ...
    <associate|bib-murphy_machine_2012|<tuple|Mur12|14>>
    <associate|eq:L-in-mstep|<tuple|4|5>>
    <associate|eq:em-mean|<tuple|8|8>>
    <associate|eq:expectation-posterior-gaussian|<tuple|7|8>>
    <associate|eq:gmm|<tuple|1|2>>
    <associate|eq:joint-complete-dataset|<tuple|6|7>>
    <associate|eq:l-as-expectation|<tuple|5|6>>
    <associate|eq:ll-decomposed|<tuple|3|4>>
    <associate|eq:max-likelihood-marginal|<tuple|2|3>>
    <associate|eq:mle-cov-resp|<tuple|11|11>>
    <associate|eq:mle-mean|<tuple|9|11>>
    <associate|eq:responsibility|<tuple|10|11>>
    <associate|fig:2msteps|<tuple|Figure 2|6>>
    ...
    <associate|sec:em-algor|<tuple|4|4>>
    <associate|sec:em-with-gm|<tuple|5|6>>
    <associate|sec:gmm-latent|<tuple|3|2>>
    <associate|sec:problems-ll|<tuple|8.2|10>>
    <associate|sec:what-next|<tuple|7|9>>
